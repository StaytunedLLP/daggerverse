...
export interface TemplateVersion {
    ...
    readonly updateUser?: { email: string };
...
// ============================================================================
// Flag Configuration (from REMOTE_CONFIG_FLAG block)
// ============================================================================
...
let loadedConfig: ConfigFile;
try {
    const configContent = readFileSync(configPath, "utf8");
    loadedConfig = JSON.parse(configContent) as ConfigFile;
} catch (error) {
...
/** Environment identifier - dynamically typed from config */
export type EnvironmentId = keyof typeof loadedConfig.environments;
...
/** Firebase project mapping - loaded from config.json */
export const FIREBASE_PROJECTS: Readonly<Record<string, EnvironmentConfig>> = 
    loadedConfig.environments as Record<string, EnvironmentConfig>;

/** Namespace mapping: user-friendly -> Firebase API */
export const NAMESPACE_MAP: Readonly<Record<NamespaceAlias, FirebaseNamespace>> = {
    client: "firebase",
